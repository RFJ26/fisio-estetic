        ...
        <div class="container-fluid">
            ...
            <div class="view-card">
                ...
                <div class="card-actions">
                    ...
                    <a href="delete.php?id=<?= $servico['id'] ?>" class="btn-delete-action ms-md-auto" onclick="return confirm('Tem a certeza que deseja apagar este serviço?');">
                        <i class="bi bi-trash me-2"></i>Apagar
                    </a>
                </div>
            </div>

            <button class="toggle-bar" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFuncionarios" aria-expanded="false">
                <div class="toggle-title">
                    <div class="toggle-icon-box icon-box-green">
                        <i class="bi bi-people-fill"></i>
                    </div>
                    <span>Profissionais Habilitados <span style="color: var(--brand-primary); opacity: 0.8; font-size: 0.9rem;">(<?= $total_funcionarios ?>)</span></span>
                </div>
                <i class="bi bi-chevron-down text-muted"></i>
            </button>

            <div class="collapse collapse-container" id="collapseFuncionarios">
                <?php if($total_funcionarios > 0): ?>
                                ...
                                <?php while($func = mysqli_fetch_assoc($result_funcionarios)): ?>
                                    <tr>
                                        <td data-label="Nome" class="fw-medium text-dark">
                                            <i class="bi bi-person-circle me-2 text-secondary"></i><?= htmlspecialchars($func['nome']) ?>
                                        </td>
                                        <td data-label="Email" class="text-secondary"><?= htmlspecialchars($func['email']) ?></td>
                                        <td data-label="Telefone"><?= htmlspecialchars($func['telefone']) ?></td>
                ...
                <?php else: ?>
                    <div class="no-data-info">
                        Ainda não existem funcionários habilitados a realizar este serviço.
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="collapse collapse-container" id="collapseMarcacoes">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td data-label="Profissional" class="text-secondary"><?= htmlspecialchars($marc['nome_funcionario']) ?></td>
                                        <td data-label="Estado" class="text-md-end pe-md-4">
                ...
                <?php else: ?>
                    <div class="no-data-info">
                        Não existem marcações futuras agendadas para este serviço.
                    </div>
                <?php endif; ?>
            </div>
